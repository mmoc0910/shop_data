...
const HomeBox = () => {
  return (
    <div
      id="home"
      className="bg-[url('https://images.unsplash.com/photo-1644088379091-d574269d422f?q=80&w=1993&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center relative"
    >
      ...
      <Container className="py-20 grid grid-cols-10 relative z-10">
        <div className="col-span-6">
          ...
          <div className="space-y-5 w-5/6">
            ...
            <div className="flex gap-5">
              <div className="w-2 h-2 bg-gray-300 rounded-full shrink-0 mt-[6px]" />
              <p className="text-white">Tốc độ truy cập nhanh</p>
            </div>
            <div className="flex gap-5">
              <div className="w-2 h-2 bg-gray-300 rounded-full shrink-0 mt-[6px]" />
              <p className="text-white">
                Bảo hành suốt quá trình sử dụng, Hỗ trợ 24/7
              </p>
            </div>
            <div className="flex gap-5">
              <div className="w-2 h-2 bg-gray-300 rounded-full shrink-0 mt-[6px]" />
              <p className="text-white">Dễ dàng cài đặt và kết nối</p>
            </div>
            <div className="flex gap-5">
              <div className="w-2 h-2 bg-gray-300 rounded-full shrink-0 mt-[6px]" />
              <p className="text-white">Chuyên thị trường China, Iran users</p>
            </div>
          </div>
        </div>
        <div className="col-span-4 pl-28 flex items-center justify-center">
          <img
        ...
        <div className="col-span-10 mt-24 mb-24">
          <div className="grid grid-cols-12">
            <div className="col-span-4">
              ...
              <div className="flex justify-between">
                ...
                <div className="col-span-1 flex flex-col gap-3 items-center">
                  ...
                  <span className="font-medium text-white">iOS</span>
                </div>
                <div className="col-span-1 flex flex-col gap-3 items-center">
                  <span>
                    <svg
            ...
            <div className="col-span-8 ml-32">
              <p className="text-white font-medium mb-5">
                ...
                <Link
                  to={"/sign-up"}
                  className="font-medium underline decoration-primary text-primary"
                >
                  Đăng ký
                </Link>
              </p>
