    ...
    <Container className="py-10 lg:py-20 space-y-5 lg:space-y-10 xl:w-[1000px] relative z-10">
      ...
      <div className="grid grid-cols-5 lg:grid-cols-10 gap-5">
        <div className="col-span-5 space-y-5">
          ...
          <div className="">
            <div className="mb-5 space-y-1 pl-8 relative after:absolute after:w-3 after:h-3 after:bg-primary after:rounded-full after:left-0 after:top-[8px] before:absolute before:h-[calc(100%+0.75rem)] before:w-[1px] before:bg-primary before:left-[6px] before:top-[8px]">
            ...
            <div className="mb-5 space-y-1 pl-8 relative after:absolute after:w-3 after:h-3 after:bg-primary after:rounded-full after:left-0 after:top-[8px]">
              <p className="font-medium text-primary text-xl lg:text-2xl tracking-wider">
                Fanpage
              </p>
              <div className="">
                <div className="flex mt-7 gap-7">
                  <Link to={""} className="flex flex-col items-center gap-5">
                    ...
                    <p className="text-sm lg:text-base font-medium">Facebook</p>
                  </Link>
                  <Link to={""} className="flex flex-col items-center gap-5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="text-sm lg:text-base font-medium">Instagram</p>
                  </Link>
                  <Link to={""} className="flex flex-col items-center gap-5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="text-sm lg:text-base font-medium">Tiktok</p>
                  </Link>
                  <Link to={""} className="flex flex-col items-center gap-5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="text-sm lg:text-base font-medium">Douyin</p>
                  </Link>
                </div>
              </div>
            </div>
